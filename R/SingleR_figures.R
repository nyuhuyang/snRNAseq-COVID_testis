...
pred5 = readRDS("output/COVID_testis_10_20220421_GuoJ2018_singleR_pred.rds")
pred6 = readRDS("output/COVID_testis_10_20220421_GuoJ2018_PBMC_singleR_pred.rds")
...
meta.data %<>% cbind("GuoJ2018.label"=pred5$pruned.labels)
meta.data %<>% cbind("GuoJ2018_PBMC.label"=pred6$pruned.labels)
...
meta.data$Shami2020_PBMC.label %<>% plyr::mapvalues(from = meta_data$celltype.l3,
                                                 to = meta_data$celltype.l1)
meta.data$GuoJ2018_PBMC.label %<>% plyr::mapvalues(from = meta_data$celltype.l3,
                                                    to = meta_data$celltype.l1)
...
meta.data$GuoJ2018.label[is.na(meta.data$GuoJ2018.label)]= "Unknown"
meta.data$GuoJ2018_PBMC.label[is.na(meta.data$GuoJ2018_PBMC.label)]= "Unknown"
